# Havre des Brumes — Boucle gameplay cible (v0.10)
...
3. Intégration du corpus **mini-jeu Lien** (`companion_link_corpus_v2_clean_compact.zip`).
...
|-------|---------|----------------|
| Nom produit | Havre des Brumes (affiché) / IDLE Isekai Chill (repo) | Inchangé |
