...
export const BUILDING_ACTIVITIES: BuildingActivity[] = [
  ...
  },
  {
    ...
    name: 'Chasse aux Myrions',
    tagline: 'Lisière — Talia',
    inspiration: 'Palworld / Pokemon GO lite',
    description:
      'Talia explore huit biomes et croise des Myrions de N à LR. Rencontres illimitées — synchronise ta capture au bon moment.',
