/**
 * Archive — panorama village v1 (1920×1080, tous bâtiments sur une seule vue).
 * Généré en panorama-v1.png via npm run generate:assets
 */
